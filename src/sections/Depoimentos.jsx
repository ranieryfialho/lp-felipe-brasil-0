...
const TESTIMONIALS = [
  {
    ...
    rating: 5,
    text: "Senti alívio em poucos dias e voltei a caminhar no parque. Procedimento rápido e sem internação.",
  ...
  },
  {
    ...
    rating: 5,
    text: "A dor que me travava no trabalho praticamente sumiu no mesmo dia. Retomei a rotina com segurança.",
    avatar: "",
  },
  {
    id: "t3",
    ...
    tag: "Radioablação",
    rating: 5,
    text: "Controle da dor de longa duração. Recuperação tranquila e sem necessidade de internação.",
    avatar: "",
  },
  {
    id: "t4",
    ...
    tag: "Laserterapia",
    rating: 4,
    text: "Sessões curtas, indolor, e melhora perceptível já nas primeiras semanas.",
    avatar: "",
  },
  {
    id: "t5",
